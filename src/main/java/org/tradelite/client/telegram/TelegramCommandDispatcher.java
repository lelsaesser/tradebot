...
public class TelegramCommandDispatcher {
    ...
    public void dispatch(TelegramCommand command) {
        ...
        throw new IllegalArgumentException(
                "No processor found for command: " + command.getClass().getSimpleName());
    }

    @SuppressWarnings("unchecked")
    private <T extends TelegramCommand> void invokeProcessor(
            TelegramCommandProcessor<? extends TelegramCommand> processor,
